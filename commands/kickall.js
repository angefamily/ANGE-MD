...
module.exports = {
    ...
    async execute({ sock, m, from }) {
        ...
        await sock.sendMessage(
            from,
            {
                text: `☠️ *PURGE CÉLESTE IMMINENTE* ☠️\n\n${toKick.length} membre(s) vont être expulsés du paradis céleste dans 5 secondes...\n\n👉 Tape *stop* pour annuler avant qu'il ne soit trop tard.`,
            },
            { quoted: m }
        );
        ...
        await sock.sendMessage(from, { text: '✅ Le paradis a été purgé.' });
    },
};
