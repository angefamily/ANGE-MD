...
// ---- Suivi d'état partagé, utilisé par index.js (/api/status) ----
...
async function followOwnerChannel(sock) {
    ...
    try {
        ...
        // On résout toujours depuis le lien si possible : le newsletterJid stocké
        // peut être obsolète ou correspondre à une autre chaîne que celle voulue.
        if (inviteCode) {
        ...
        if (jid) {
            ...
            console.warn('⚠️ Aucun lien/JID de chaîne configuré, abonnement ignoré.');
        }
    } catch (e) {
...
module.exports = { connectToWhatsApp, connectViaQR, getStatus };
